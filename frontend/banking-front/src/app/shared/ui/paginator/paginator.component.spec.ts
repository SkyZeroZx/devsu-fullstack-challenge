...
describe('PaginatorComponent', () => {
  ...
  it('displays page counter as "page + 1 / totalPages"', async () => {
    host.page.set(2);
    await fixture.whenStable();
  ...
  it('emits page 1 when next button is clicked from page 0', async () => {
    findEl(fixture, 'btn-next').nativeElement.click();
    await fixture.whenStable();
    expect(host.emittedPage).toBe(1);
  });

  it('emits page 0 when first button is clicked from page 3', async () => {
    host.page.set(3);
    await fixture.whenStable();
    findEl(fixture, 'btn-first').nativeElement.click();
    await fixture.whenStable();
    expect(host.emittedPage).toBe(0);
  });
  ...
  it('emits last page index when last button is clicked', async () => {
    ...
    await fixture.whenStable();
    expect(host.emittedPage).toBe(9);
  });
